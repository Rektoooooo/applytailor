        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-violet-50 to-purple-50 text-violet-700 rounded-full text-sm font-medium mb-6 border border-violet-100">
                <MessageSquare className="w-4 h-4" />
                New Feature
              </div>

              <h2 className="text-3xl lg:text-4xl font-bold text-charcoal mb-4 leading-tight">
                Smart Reply: Never struggle with{' '}
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Got an interview invite? A rejection? A follow-up? Paste any recruiter email and get a perfectly crafted, professional response in seconds.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-charcoal">Save hours on email responses</h4>
                    <p className="text-sm text-slate-500">What takes 20 minutes to write now takes 20 seconds</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-charcoal">Always professional, never generic</h4>
                    <p className="text-sm text-slate-500">Contextual replies that sound like you, not a robot</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-charcoal">Multi-language support</h4>
                    <p className="text-sm text-slate-500">Detects language automatically and replies in kind</p>
                  </div>
                </div>
              </div>
              ...
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-medium rounded-xl hover:from-violet-700 hover:to-purple-700 transition-all shadow-lg shadow-violet-500/25"
              >
                Try Smart Reply
                <ArrowRight className="w-4 h-4" />
              </Link>
            ...
            >
              ...
              <div className="bg-white rounded-2xl shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                ...
                <div className="p-4 space-y-4 bg-gradient-to-b from-slate-50/50 to-white">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="bg-white rounded-2xl rounded-tl-sm p-3 border border-slate-100 shadow-sm max-w-[85%]">
                      <div className="text-[10px] text-slate-400 mb-1">From: recruiter@stripe.com</div>
                      <p className="text-sm text-charcoal leading-relaxed">
                        Hi! We were impressed by your application. Would you be available for a 30-minute call this week to discuss the Senior Designer role?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-2 py-2">
                    ...
                    <span className="px-2 py-1 bg-slate-50 text-slate-400 text-[10px] font-medium rounded-full border border-slate-100">
                      Auto-detected
                    </span>
                  </div>
                  ...
                  <div className="flex gap-3 justify-end">
                    <div className="bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl rounded-tr-sm p-3 shadow-lg shadow-teal-500/20 max-w-[85%]">
                      <div className="text-[10px] text-teal-100 mb-1 flex items-center gap-1">
                        <Sparkles className="w-3 h-3" />
                        AI Generated Reply
                      </div>
                      <p className="text-sm text-white leading-relaxed">
                        Thank you for reaching out! I'm very excited about the opportunity to discuss the Senior Designer role at Stripe. I'm available Thursday or Friday afternoon this week. Please let me know what works best for your schedule.
                      </p>
                    </div>
                ...
                <div className="px-4 py-3 border-t border-slate-100 bg-white flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-slate-400">Copy to clipboard</span>
                  </div>
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="absolute -left-4 top-8 bg-white rounded-xl shadow-xl shadow-slate-200/50 p-3 border border-slate-100"
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-[11px] font-semibold text-charcoal">3 Free Replies</div>
                    <div className="text-[10px] text-slate-400">Then 5 for 0.10 credits</div>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="absolute -right-2 bottom-20 bg-white rounded-xl shadow-xl shadow-slate-200/50 p-2 border border-slate-100"
              >
                <div className="flex items-center gap-1.5">
                  <div className="flex -space-x-1">
                    <div className="w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center text-[8px] font-bold text-blue-600 border-2 border-white">EN</div>
                    <div className="w-5 h-5 bg-red-100 rounded-full flex items-center justify-center text-[8px] font-bold text-red-600 border-2 border-white">DE</div>
                    <div className="w-5 h-5 bg-emerald-100 rounded-full flex items-center justify-center text-[8px] font-bold text-emerald-600 border-2 border-white">FR</div>
                  </div>
                  <span className="text-[10px] text-slate-500">+12 languages</span>
                </div>
              </motion.div>

              {/* Decorative gradient */}
              <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-br from-violet-200/30 via-purple-200/20 to-transparent rounded-full blur-3xl" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 px-6 border-t border-slate-100">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <img src="/logo.png" alt="ApplyTailor" className="w-9 h-9 object-contain rounded-lg" />
